...
import { Shield, Lock, Database, HardDrive, CheckCircle } from "lucide-react";
        ...
        <div className="container-lg relative z-10">
          ...
          >
            ...
            <p className="text-body-lg text-white/90 mb-8">
              Your data is isolated at the database level, not just the app
              level. Enterprise-grade security with daily backups and
            ...
            {[
              ...
              return (
                ...
                >
                  ...
                  <h3 className="text-h5 text-slate-900 mb-2">
                    {feature.title}
                  </h3>
